...
},
{
  ...
  "number": "3.1.3",
  "title": "Even or Odd.",
  "body": "Even or Odd  Is -5 even or odd?  where . Thus, is odd.  Is 0 even or odd?  where . Thus, is even.  Let . Is even or odd?  where . Thus is even.  Let . Is even or odd?  where . Thus is odd.  "
},
{
  "id": "A_evenoddneither",
  "level": "2",
...
},
{
  ...
  "body": "Prove or Disprove  Prove or disprove there exists a positive integer such that is prime.  Since we need to try to decide if the statement is true or false, first try some examples.   not prime.  not prime.  not prime.   After trying several examples, we might guess that it is false. If we want to disprove the statement then we need to prove the negation. Find the negation of the statement.  For all positive integers is not prime (is composite).  So we need to show that for a general we can always write as a product of with .  We can try to factor the expression: .  Let . We need to show that . Since and . Thus . Therefore, is not prime.  "
},
{
  "id": "A_provedisprove",
  "level": "2",
...
},
{
  ...
  "body": "Rational Numbers  Is rational?  Yes: .  Is rational?  Yes: .  Is rational?  Yes: it already has the form of an integer over an integer.  Is rational?  No: the denominator cannot be . In fact, is not a number.  "
},
{
  "id": "E_termdecimal",
  "level": "2",
...
},
{
  ...
  "body": "Finding Divisors  Find the divisors of 6.   Find the divisors of 5.   Find the divisors of 1.   "
},
{
  "id": "E_TFdivides",
  "level": "2",
...
},
{
  ...
  "number": "6.1.2",
  "title": "",
  "body": " In this exercise we find the 7th row of Pascal's triangle using the binomial coefficients.    Use Pascal’s triangle to compute the values of and     Use the result of part (a) and Pascal’s Formula to compute , , and .    Complete the row of Pascal’s triangle that corresponds to .    "
},
{
  "id": "binomial9-30-3",
  "level": "2",
