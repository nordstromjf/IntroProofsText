...
},
{
  ...
  "body": "Biconditional as Two Conditionals We read the biconditional as if and only if . Determine which of the two statements and is equivalent to if and which is only if . Think about when each statement should be true (or false). "
},
{
  "id": "T_nand",
  "level": "2",
...
},
{
  ...
  "number": "3.1.3",
  "title": "Prove or Disprove.",
  "body": "Prove or Disprove Prove or disprove the following statements.  If is even, then is even.  If is odd, then is odd.  If are odd, then their product, , is odd.  "
},
{
  "id": "exercise-36",
  "level": "2",
...
},
{
  ...
  "number": "4.4.4",
  "title": "",
  "body": " Let be the sequence defined as    Use strong induction to prove that or all integers .  "
},
{
  "id": "exercise-98",
  "level": "2",
...
},
{
  ...
  "body": "Cardinality of the Even Integers Let be the set of even integers, . Consider the map given by . You can check that is one-to-one and onto . Thus, gives us a one-to-one correspondence between the integers and the even integers. Hence, they have the same cardinailty. "
},
{
  "id": "D_countable",
  "level": "2",
